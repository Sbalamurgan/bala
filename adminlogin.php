...
<body>
    <form method="post" action="adminauthenticate.php" name="myform">
        <div class="container">
            <h1>Log In</h1>
            ...
            <input type="text" placeholder="Enter Email" name="user_mail" id="user_mail" >
        ...
        function validate()
{
    ...
    let x=document.forms["myForm"]["user_ame"].value;
