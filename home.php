...
<center>
<div class="rectangle">
        <a href="add.php"><i class="fa fa-user" style='font-size:48px;color:white'> Teaching Staff</i></a>
</div>
<div class="rec">
        <a href="detail.php"><i class="fa fa-user-circle-o" style='font-size:48px;color:white'> Non-Teaching Staff</i></a>
</div>
</center>
</body>
</html>
